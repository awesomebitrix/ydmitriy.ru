...
$APPLICATION->SetPageProperty("description", "Персональный сайт Языкова Дмитрия веб-разработчика, bitrix специалиста");
...
$APPLICATION->SetPageProperty("title", "Языков Дмитрий - Веб-разработчик");
$APPLICATION->SetTitle("Языков Дмитрий - Веб-разработчик");
?>
<?$APPLICATION->IncludeComponent("bitrix:news.list", "main_page", Array(
        ...
        "PAGER_TEMPLATE" => "beauty",	// Шаблон постраничной навигации
