...
<div id="text">
	...
	<div>
		 Есть опыт проектирования и разработки сложных сайтов, веб-приложений и корпоративных порталов (на текущем месте работы нашими заказчиками
        были FordSollers, Татнефть и др. Подробнее можно узнать <a href="http://ydmitriy.ru/portfolio/">здесь</a>).
	</div>
	<div>
	...
	<div>
		 ...
		 2012 - по настоящее время: <a href="http://gkk.ru/sites/">ООО "Фирма Лист"</a>, веб-программист.
	</div>
